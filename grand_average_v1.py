...
for t in trial_type:
    ...
    for subj in subjects:
        ...
        for r in rounds:
            for fb_cur in feedback:
                try:
                    epochs = mne.read_epochs('/net/server/data/Archive/prob_learn/vtretyakova/beta_16_30_epo_comb_planar/{0}_run{1}_{2}_fb_cur_{3}_beta_16_30-epo_comb_planar.fif'.format(subj, r, t, fb_cur), preload = True)
    ...
    grand_averange.save('/net/server/data/Archive/prob_learn/vtretyakova/grand_average_beta_16_30_resp/ave_beta_16_30_resp_{0}.fif'.format(t))
