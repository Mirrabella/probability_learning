...
description = 'Выделяем частоты и при корректировке на бейзлан, каждое значение данных делим на бейзлан и логарифмируем. Затем туже процедуру проводим с бейзлайном, чтобы получить ошибку, которую потом вычетаем и данных (вторая корректировка на бейзлайн.'
