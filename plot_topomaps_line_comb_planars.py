...
t_stat_risk, p_val_risk, risk_mean = ttest_vs_zero(data_path, subjects, parameter1 = 'risk', n = n)

fig, temp = plot_topo_vs_zero(p_val_risk, temp, risk_mean, time_to_plot, title = 'risk vs zero, no FDR')
...
temp.save('/home/vtretyakova/Рабочий стол/probability_learning/evoked_for_topo/risk_vs_0.fif')  # save evoked data to disk
